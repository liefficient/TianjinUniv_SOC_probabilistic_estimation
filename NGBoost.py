...
#****************************************Self-made experimental dataset1,Training:FUDS_50SOC_zizhi,Testing:DST_50SOC_zizhi、NEDC_50SOC_zizhi****************************************
...
# number 29130
DST_50SOC=pd.read_csv('DST4Ah50-VISOC.csv')
DST_50SOC=DST_50SOC[['V','I','SOC']]

# number 41971
FUDS_50SOC=pd.read_csv('FUDS4Ah50-VISOC.csv')
FUDS_50SOC=FUDS_50SOC[['V','I','SOC']]

# number 25242
NEDC_50SOC=pd.read_csv('NEDC4Ah50-VISOC.csv')
